	...
	protected void doPost(HttpServletRequest request,
		...
		request.setAttribute(
				...
				"<table id='datagrid' class='easyui-datagrid' title='用户'"
						...
						+ "<div class='fitem'><label>用户名：</label>"
						+ "<input name='accountID' class='easyui-validatebox' required='true'></div><br>"
						+ "<div class='fitem'><label>密    码：</label>"
						+ "<input name='psd' class='easyui-validatebox' required='true' type='password'></div><br>"
						+ "<div class='fitem'><label>姓    名：</label>"
						+ "<input name='name' class='easyui-validatebox' required='true'></div><br>"
						+ "<div class='fitem'><label>角    色：</label>"
						+ "<select id='selectAccountGroupID' name='accountGroupID' class='easyui-combobox' style='width:200px' panelHeight='auto'>"
